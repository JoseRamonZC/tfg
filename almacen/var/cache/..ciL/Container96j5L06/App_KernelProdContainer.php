...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/symfony/monolog-bridge/Handler/MailerHandler.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/mailer/MailerInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/mailer/Mailer.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/mime/RawMessage.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/mime/Message.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/mime/Email.php';
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MSku3V3Qy4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getMonolog_Handler_MainService()
    {
        ...
        $a->pushProcessor($b);
        $c = ($this->privates['mailer.transports'] ?? $this->getMailer_TransportsService());
        ...
        $e = new \Symfony\Bridge\Monolog\Handler\MailerHandler(new \Symfony\Component\Mailer\Mailer($c, ($this->services['messenger.default_bus'] ?? $this->getMessenger_DefaultBusService()), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService())), $d, 100, true);
        $e->pushProcessor($b);

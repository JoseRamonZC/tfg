 ...
 */
class getKnpPaginatorService extends App_KernelEnvDebugContainer
{
    /**
    ...
    {
        if ($lazyLoad) {
            return $container->services['knp_paginator'] = $container->createProxy('Paginator_f262b94', function () use ($container) {
                return \Paginator_f262b94::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {

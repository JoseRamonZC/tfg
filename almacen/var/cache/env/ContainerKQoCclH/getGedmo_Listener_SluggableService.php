 ...
 */
class getGedmo_Listener_SluggableService extends App_KernelEnvDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['gedmo.listener.sluggable'] = $instance = new \Gedmo\Sluggable\SluggableListener();

...
class App_KernelProdContainer extends Container
{
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dpPbxJJ0xy', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getMailer_MailerService()
    {
        ...
        return $this->privates['mailer.mailer'] = new \Symfony\Component\Mailer\Mailer($a, ($this->services['messenger.default_bus'] ?? $this->getMessenger_DefaultBusService()), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()));
    }
    ...
    protected function getMonolog_Handler_MainService()
    {
        ...
        if (isset($this->privates['monolog.handler.main'])) {
            return $this->privates['monolog.handler.main'];
        }
        $d = new \Symfony\Component\Mime\Email();
        $d->from('info@serglobinmelilla.es');
        $d->to('ricardonb@serglobin.es');
        $d->subject('!Error en la aplicación de Emvismesa Fianzas! %message%');

        $e = new \Symfony\Bridge\Monolog\Handler\MailerHandler($c, $d, 100, true);
        $e->pushProcessor($b);
        $e->setFormatter(new \Monolog\Formatter\HtmlFormatter());

        return $this->privates['monolog.handler.main'] = new \Monolog\Handler\FingersCrossedHandler(new \Monolog\Handler\GroupHandler([0 => $a, 1 => new \Monolog\Handler\DeduplicationHandler($e, ($this->targetDir.''.'/monolog_dedup_922a7b2c3485f2fca0b658c7a9e614d9d914a2f5'), 400, 60, true)], true), new \Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy(500), 0, true, true, NULL);
    }

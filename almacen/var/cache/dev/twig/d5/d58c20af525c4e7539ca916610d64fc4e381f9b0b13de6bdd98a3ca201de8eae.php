...
<html lang=\"es\">
    <head>
        <meta charset=\"utf-8\" />
        <title>TFG Inventario | Iniciar sesión</title>
    ...
    <body id=\"kt_body\" class=\"bg-body app-blank\">
        ...
        echo "\" method=\"post\">
                            ...
                            <div class=\"fv-row mb-10\">
                                <label for=\"_username\" class=\"form-label fs-6 fw-bolder text-dark\">Usuario</label>
                                <input id=\"_username\" class=\"form-control form-control-lg form-control-solid\" type=\"text\" name=\"_username\" autocomplete=\"off\" required autofocus />
                            </div>
                            <div class=\"fv-row mb-10\">
                                <div class=\"d-flex flex-stack mb-2\">
                                    <label for=\"_password\" class=\"form-label fw-bolder text-dark fs-6 mb-0\">Contraseña</label>
                                </div>
                                <input id=\"_password\" class=\"form-control form-control-lg form-control-solid\" type=\"password\" name=\"_password\" autocomplete=\"off\" />

...
class __TwigTemplate_cb9615502deeead0f2aead2e795b0073038aac36864081d31c62cfb7b744992e extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"app-content flex-column-fluid\" id=\"kt_app_content\">
        ...
        // line 35
        echo twig_escape_filter($this->env, (isset($context["categoria"]) || array_key_exists("categoria", $context) ? $context["categoria"] : (function () { throw new RuntimeError('Variable "categoria" does not exist.', 35, $this->source); })()), "html", null, true);
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["categorias"]) || array_key_exists("categorias", $context) ? $context["categorias"] : (function () { throw new RuntimeError('Variable "categorias" does not exist.', 57, $this->source); })()));
        ...
        echo "                        </tbody>
            ...
            <div class=\"card-footer\">
                <div class=\"navigation\">
                    ";
        // line 78
        echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->render($this->env, (isset($context["categorias"]) || array_key_exists("categorias", $context) ? $context["categorias"] : (function () { throw new RuntimeError('Variable "categorias" does not exist.', 78, $this->source); })()));
        echo "
                </div>
            </div>
        </div>
...
";
    ...
    {
        return array (  189 => 78,  181 => 72,  169 => 66,  161 => 61,  156 => 59,  153 => 58,  149 => 57,  124 => 35,  96 => 10,  88 => 4,  78 => 3,  59 => 2,  36 => 1,);
    }
        ...
        <form action=\"\" method=\"get\">
            <div class=\"card mb-7\">
                <div class=\"card-body\">
                    <div class=\"d-flex align-items-center\">
                        <div class=\"position-relative w-md-400px me-md-2\">
                            <input type=\"text\" class=\"form-control form-control-solid ps-10\" name=\"categoria\" value=\"{{ categoria }}\" placeholder=\"Categoría\" />
                        </div>
                        <div class=\"d-flex align-items-center\">
                            <button type=\"submit\" class=\"btn btn-primary me-5\">Buscar</button>
                        </div>
                        ...
                        <tbody>
                            {% for objeto in categorias %}
                                <tr>
                                    <td>{{ objeto.nombre }}</td>
                                    <td class=\"text-center align-middle\">
                                        <a class=\"btn btn-secondary btn-icon\" href=\"{{ path('subcategories_index',{'id':objeto.id}) }}\">
                                            <i class=\"las la-list fs-2x\"></i>
                                        </a>
                                    </td>
                                    <td class=\"text-center align-middle\">
                                        <a class=\"btn btn-primary btn-icon\" href=\"{{ path('categories_show',{'id':objeto.id}) }}\">
                                            <i class=\"las la-eye fs-2x\"></i>
                                        </a>
                                    </td>
                                </tr>
...
{% endblock %}", "categoria/index.html.twig", "C:\\xampp\\htdocs\\tfg\\almacen\\templates\\categoria\\index.html.twig");
    }
}

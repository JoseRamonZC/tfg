...
class TrasladoLote {
     ...
     * @var \Traslado
     *
     * @ORM\ManyToOne(targetEntity="Traslado", inversedBy="lotes")
     * @Gedmo\Versioned()
     * @ORM\JoinColumns({
     ...
     * @var \Lote
     *
     * @ORM\ManyToOne(targetEntity="Lote", inversedBy="traslados")
     * @Gedmo\Versioned()
     * @ORM\JoinColumns({
    ...
    public function getTraslado(): ?Traslado
    {
        return $this->traslado;
    }

    public function setTraslado(?Traslado $traslado): self
    {
